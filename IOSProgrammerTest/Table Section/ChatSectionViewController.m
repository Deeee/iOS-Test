...
- (void)viewDidLoad
{
    ...
    // Make cell auto determine height
    self.tableView.estimatedRowHeight = 80;
    self.tableView.rowHeight = UITableViewAutomaticDimension;
    
//    NSLog(@"font name check %@",[UIFont fontWithName:@"Machinato" size:22].fontName);
//    _header.font = FONT_M_EL(22);
    [self loadJSONData];
    
    
}

/* Description: Load Json data into the cell */
- (void)loadJSONData
{
